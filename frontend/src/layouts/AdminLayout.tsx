...
export function AdminLayout() {
  ...
  const isBuilderOpen = location.pathname === '/admin/modules' && new URLSearchParams(location.search).get('builder') === '1';
    ...
    <div className="min-h-screen bg-dark-bg text-slate-100">
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <main className="flex min-w-0 flex-1 flex-col">
          <div className={`flex-1 overflow-y-auto ${isBuilderOpen ? 'p-0' : 'p-4 md:p-8'}`}>
            <div className={`mx-auto w-full ${isBuilderOpen ? '' : 'max-w-[1600px]'}`}>
              <Outlet />
            </div>
          </div>
        </main>
